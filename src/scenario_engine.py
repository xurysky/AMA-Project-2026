    ...
    def _seasonal_state(self, season: str) -> Dict[str, Any]:
        ...
        scenarios: Dict[str, Dict[str, Any]] = {
            ...
            "summer": {
                ...
                "business_calendar": {"in_season_focus": ["contoso_air", "shorts", "dry_ex", "uv_protection", "linen", "kids"], "off_season_clearance": ["outerwear", "fleece", "thermal_innerwear"], "decision_window_days": 14},
                "products": [
                    ...
                    self._product("UV-002", "UV Protection Air Hoodie", "uv_protection", 118, 240, 860, 2, 199, 78, 0.42, 42, [31,36,44,59,78,96,128], 18800, 1460, 410, {"zara":259,"hm":199,"local_brand":169}, "summer_in_season"),
                    self._product("LINEN-002", "Premium Linen Short Sleeve Shirt", "linen", 420, 210, 930, 3, 199, 72, 0.42, 36, [30,34,39,43,50,57,66], 12600, 820, 190, {"zara":249,"hm":179,"gap":229}, "summer_in_season"),
                    self._product("BRA-001", "Airism Bra Top", "contoso_air", 156, 280, 780, 2, 129, 46, 0.45, 64, [48,57,69,82,105,130,151], 22100, 1980, 360, {"zara":159,"hm":129,"local_brand":99}, "summer_in_season"),
                    self._product("KIDS-DRY-001", "Kids DRY-EX Anti-sweat Tee", "kids", 86, 180, 640, 2, 79, 28, 0.43, 38, [29,35,44,61,76,91,118], 16400, 1210, 240, {"zara":99,"hm":79,"local_brand":59}, "summer_in_season"),
                    self._product("JEANS-001", "Ultra Stretch Jeans", "denim", 610, 260, 920, 3, 249, 108, 0.40, 28, [31,30,29,28,27,27,26], 5300, 260, 88, {"zara":299,"hm":229,"gap":279}, "carryover_core"),
                    self._product("CAP-001", "UV Protection Cap", "accessories", 188, 160, 520, 1, 79, 24, 0.45, 32, [21,28,35,48,63,77,85], 9200, 710, 0, {"zara":99,"hm":69,"local_brand":49}, "summer_in_season"),
                    ...
                    self._product("FLEECE-002", "Soft Fleece Full-Zip Jacket", "fleece", 730, 180, 440, 2, 199, 82, 0.40, 10, [16,14,12,10,8,7,6], 2100, 90, 18, {"zara":249,"hm":179,"gap":219}, "off_season_clearance", 25),
                    self._product("HT-002", "HEATTECH Crew Neck T-Shirt", "thermal_innerwear", 960, 240, 720, 1, 149, 58, 0.42, 12, [20,18,15,12,10,8,7], 2600, 120, 20, {"zara":149,"hm":119,"local_brand":99}, "off_season_clearance", 20),
                ],
                "customers": self._seasonal_customers("summer", ["Contoso Air Cotton Oversized T-Shirt", "UV Protection Air Hoodie"]),
            },
            "autumn": {
                "season": "autumn",
                "season_label": "秋季",
